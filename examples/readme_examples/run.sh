...
ssm run -p ${2}simple-sagemaker-example-cli -t cli-task1${3} -e $BASEDIR/worker1.py -o $1/example1 --it ml.p3.2xlarge --no_spot --ic 2 ${@:4} --max_run_mins 15 &
...
ssm run -p ${2}simple-sagemaker-example-cli -t cli-task6-1${3} -s $BASEDIR/example6/code -e worker6.py \
...
# Shell example
ssm shell -p ${2}simple-sagemaker-example-cli -t shell-task${3} --cmd_line "cat /proc/cpuinfo && nvidia-smi" -o $1/example_cmd --it ml.p3.2xlarge ${@:4} --max_run_mins 15 &
...
ssm run -p ${2}simple-sagemaker-example-cli -t cli-task6-2${3} -s $BASEDIR/example6/code -e worker6.py \
